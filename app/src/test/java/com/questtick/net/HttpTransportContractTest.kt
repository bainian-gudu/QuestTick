...
class HttpTransportContractTest {
    @Test
    fun fakeReceivesImmutableRequestSnapshotAndExplicitConfig() =
        runTest {
    ...
    @Test
    fun defaultGetAndPostForceOneShotWhileIdempotentGetIsExplicit() =
        runTest {
            val fake = FakeHttpTransport { request -> HttpResponse.text(200, "ok", request.url) }
    ...
    @Test
    fun httpErrorResultDoesNotExposeResponseBody() =
        runTest {
            val fake =
    ...
    @Test
    fun resultMappingKeepsStructuredFailureWithoutLeakingRawExceptionMessage() =
        runTest {
            val failure =
                HttpFailure(
    ...
    @Test
    fun resultMappingPropagatesCancellation() =
        runTest {
    ...
    @Test
    fun fakeStreamingTransportSupportsProgressLimitAndIsolation() =
        runTest {
            val first =
    ...
    @Test
    fun fakeStreamingResponseEnforcesConfiguredLimit() =
        runTest {
    ...
    @Test
    fun fakeInstancesKeepRequestsIsolated() =
        runTest {
